...
- [Local Offline Analysis](getting-started/personas/offline-analysis.md)

## For Security Teams

- [DevSecOps Quick Start](getting-started/personas/devsecops-quickstart.md)
- [Team Management & Organizations](team/organizations.md)
- [Analytics & Reporting](team/analytics.md)
...
- [S3 Bucket Scanning](integration/s3-scanning.md)
- [Repository Integration](integration/repository-integration.md)

## For IDE & Tool Integrators

- [Integrator Quick Start](getting-started/personas/integrator-quickstart.md)
...
### AI-Assisted API Security Analysis

- [Overview & ML Models](analysis/api-security.md)

### Dependency Vulnerability Scanning

- [Overview & Coverage](analysis/dependency-analysis.md)

## AI-Powered Explanations & Fixes (LLM-Based)

- [Overview](user-guide/llm-features.md)
- [Vulnerability Explanations](user-guide/llm-explanations.md)
- [AI-Generated Code Fixes](user-guide/llm-code-fixes.md)
- [Natural Language Queries](user-guide/llm-queries.md)
...
- [IDE Extensions](integration/extensions.md)
