...
impl OsvClient {
    ...
    ) -> osv::schema::Ecosystem {
        match ecosystem {
            crate::domain::vulnerability::value_objects::Ecosystem::Npm => {
                osv::schema::Ecosystem::Npm
            }
            crate::domain::vulnerability::value_objects::Ecosystem::PyPI => {
                osv::schema::Ecosystem::PyPI
            }
            crate::domain::vulnerability::value_objects::Ecosystem::Maven => {
                osv::schema::Ecosystem::Maven(String::new())
            }
            crate::domain::vulnerability::value_objects::Ecosystem::Cargo => {
                osv::schema::Ecosystem::CratesIO
            }
            crate::domain::vulnerability::value_objects::Ecosystem::Go => {
                osv::schema::Ecosystem::Go
            }
            crate::domain::vulnerability::value_objects::Ecosystem::Packagist => {
                osv::schema::Ecosystem::Packagist
            }
            crate::domain::vulnerability::value_objects::Ecosystem::RubyGems => {
                osv::schema::Ecosystem::RubyGems
            }
            crate::domain::vulnerability::value_objects::Ecosystem::NuGet => {
                osv::schema::Ecosystem::NuGet
            }
        }
    }
